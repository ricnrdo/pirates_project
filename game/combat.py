...
class Bat(Monster):
    def __init__(self, name):
        attacks = {}
        attacks["bite"] = ["bites", random.randrange(35, 51), (1, 10)]
        attacks["scratch"] = ["scratches",random.randrange(35,51), (1,10)]
        attacks["Batting Wing"] = ["batting Wings",random.randrange(35,51), (1,10)]

        super().__init__(name, random.randrange(15,29), attacks, 123 + random.randrange(-20, 36))